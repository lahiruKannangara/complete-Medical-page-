...
<head>
    ...
    <link  rel="stylesheet" type="text/css" href="styles/contactusedit.css"> 
...
<li><a style="color: lightseagreen; " href="signup.php"> <b> SIGN UP </b> </a></li>
    ...
    <form id="form" style="margin-top: -600px" method="POST" action="contactusDB.php" >
      <br>
      <br>
        <h2 style="font-size:35px;" >Contact Us!</h2>
      <p id="salutation" >Say Hello! Or Give Suggestions !</p>
        <div id="logo" class="icon-ic-drafts-24px"></div>
        <input id="inputt" style="color: black;" name="name" type="text"
      placeholder="Name" id="name" required/>
        
        <input id="inputt" name="email" type="email"
      placeholder="Email" id="email" required/>
        
        <textarea id="inputt" name="message" placeholder="Message" required></textarea>
        
        <br>
    
         <input id="submit" type="submit" value="Send" id="button-blue"/>
      </form>
