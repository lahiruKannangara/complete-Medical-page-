...
<head>
    ...
    <link  rel="stylesheet" type="text/css" href="styles/aboutus1.css"> 
...
<form >
    ...
    <button type="submit">Search</button>
        ...
        <ul class="main-nav">    
           <li> <h2 style="font-size:20px;" id="name" > &nbsp&nbsp&nbsp CURE PLUS <br> AMBULANCE SERVICE </h2> </li>
...
<div class = "d">
		<h1>About Us</h1><br/>
				<p>Our ambulance service has been Sri Lanka's number one due to the way we treat our patients and we arrive to your doorstep after few more minutes with a doctor who's a physician posseses the knowledge about every disease.The customers are satisfied the way we treat our patients and they have made us the number one by giving us good feedbacks. We assure you our customer service is the greatest.</p>
