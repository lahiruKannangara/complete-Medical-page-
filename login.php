...
<p  style="color:white; position:absolute; margin-top:32px; margin-left:88%; font-size: 18.5px; "  >Hi <?php echo $_SESSION['username']; ?>!  <a style="color:lightseagreen; text-decoration:none;" href="index.php?logout='1'" style="color: red;">logout</a> </p>
<?php endif ?>
...
<li class="active"><a style="color: lightseagreen; " href="login.php"> <b> LOG IN </b> </a></li>
<li><a style="color: lightseagreen; " href="signup.php"> <b> SIGN UP </b> </a></li>
    ...
    <div class="login-box">
        <img src="images/avatar.png" class="icon">
            <h1>Login Here</h1>
    ...
    <div class="footer-social-icons">
        <ul>
            ...
            <li> <a href="http://www."  target = "blank"><i class="fa fa-twitter"></i></a></li>
